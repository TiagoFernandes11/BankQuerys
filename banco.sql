...
insert into conta values(null,'000000',5000.00,'27/10/2022',1,1);
...
select p.nome, p.email as 'endereço de e-mail', p.nascimento, e.estado, e.bairro, e.rua, e.numero , g.nome as 'gerente da conta',c.idconta as 'id da conta', c.saldo as 'saldo atual', c.datadecriacao as 'data de criação', a.idagencia as agencia, b.nome as banco
from proprietario p
